    ...
    const mobileApplicationProjects = [
        {
            ...
            description: "Developed a responsive e-commerce app with Flutter, Firebase integration, advanced search, and product categorization to enhance user experience.",
            image: grocery_img,
            github: "https://github.com/Aroon1504/Grocery-Application"
        },
        {
            title: "Handwriting Recognizer",
            description: "Designed and developed a versatile OCR application with a user-friendly Flutter UI, integrated Python server for OCR using py-tesseract, incorporated image processing algorithms for enhanced accuracy, and included a text editor for convenient text editing.",
    ...
    const webApplicationProjects = [
        {
            ...
            description: "A ML based application developed using python, HTML, and CSS.",
            image: abalone_img,
